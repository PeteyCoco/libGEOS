...
TArray<FVector> FGEOSLineStringReader::ReadWKT(const FString& WKTString)
{
...
std::unique_ptr<Geometry> FGEOSLineStringReader::ConvertToGeometry_(const FString& WKTString)
{
